            ...
            return [
                `${prefixCls}-fixed`,
                {
                    [`${prefixCls}-fixed-shadow`]:
                        ...
                        (this.fixedShadow === "auto" && !this.scrollOnTheLeft)
                }
            ];
        },
        fixedRightTableClasses() {
            return [
                `${prefixCls}-fixed-right`,
                {
                    [`${prefixCls}-fixed-shadow`]:
                        this.fixedShadow === "show" ||
                        (this.fixedShadow === "auto" && !this.scrollOnTheRight)
                }
            ];
        },
        fixedHeaderClasses() {
        ...
        handleCurrentRow(type, _index, rowKey) {
            ...
            for (let i in this.objData) {
                if (this.objData[i]._isHighlight) {
                    ...
                    const resetData = this.handleResetChildrenRow(
                        this.objData[i]
                    );
                    if (resetData)
            ...
            const newData =
                type === "highlight"
                    ? rowKey
                        ? JSON.parse(
                              JSON.stringify(this.getBaseDataByRowKey(rowKey))
                          )
